...
_Generated 2026-05-03 via `yarn audit:inventory`. Re-run after changes._
...
| --- | --- | --- | --- | --- | --- | --- |
| `aaa-driving-costs` | AAA Your Driving Costs | reference | 2026-05-02 | _never_ | `200` | 2 refs |
| `bls-cex` | BLS Consumer Expenditure Survey | original | 2026-05-02 | _never_ | `403` | 2 refs |
| `bls-cex-regional` | BLS Consumer Expenditure Survey — regional tables | original | 2026-05-02 | _never_ | `403` | 2 refs |
| `care-com-childcare` | Care.com Cost of Care Report | reference | 2026-05-02 | 2026-05-03 | `200` | 2 refs |
| `cbpp-snap-bbce` | CBPP: SNAP Broad-Based Categorical Eligibility | reference | 2026-05-02 | _never_ | `403` | 2 refs |
| `child-care-aware` | Child Care Aware — Price of Care | reference | 2026-05-02 | 2026-05-03 | `200` | 2 refs |
| `eia-residential` | EIA Residential Energy Consumption | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `epi-family-budget-calculator` | EPI Family Budget Calculator — methodology | reference | 2026-05-02 | _never_ | `403` | 2 refs |
| `hhs-poverty-guidelines` | HHS Poverty Guidelines | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `hud-fair-market-rents` | HUD Fair Market Rents (FY2026) | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `hud-handbook-4350-3` | HUD Handbook 4350.3 — Occupancy Requirements | reference | 2026-05-02 | 2026-05-02 | `200` | 2 refs |
| `insurekidsnow` | InsureKidsNow.gov | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `irs-rev-proc-2025-32` | IRS Rev. Proc. 2025-32 | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `kff-employer-health-benefits` | KFF Employer Health Benefits Survey | reference | 2026-05-02 | 2026-05-03 | `200` | 3 refs |
| `kff-medicaid-expansion` | KFF: Status of State Medicaid Expansion Decisions | reference | 2026-05-02 | _never_ | `200` | 2 refs |
| `medicaid-gov` | Medicaid.gov | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `medicaid-gov-chip-eligibility` | Medicaid.gov: CHIP Eligibility Levels | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `ncsl-state-min-wage` | NCSL State Minimum Wage Chart | reference | 2026-05-02 | _never_ | `200` | 2 refs |
| `numbeo-cost-of-living` | Numbeo cost-of-living indices (cross-check) | reference | 2026-05-02 | _never_ | `200` | 2 refs |
| `rentcafe-national` | RentCafe National Apartment List | reference | 2026-05-02 | _never_ | `403` | 2 refs |
| `ssa-wage-base` | SSA Contribution and Benefit Base | original | 2026-05-02 | _never_ | `403` | 2 refs |
| `tax-foundation-state-rates` | Tax Foundation: 2026 State Income Tax Rates and Brackets | reference | 2026-05-02 | _never_ | `200` | 2 refs |
| `usda-snap-eligibility` | USDA SNAP Eligibility & Benefit Amounts | original | 2026-05-02 | _never_ | `200` | 2 refs |
| `zillow-rent-by-bedroom` | Zillow Rent by Bedroom Count | reference | 2026-05-02 | _never_ | `403` | 2 refs |
| `zillow-rent-index` | Zillow Observed Rent Index | reference | 2026-05-02 | _never_ | `403` | 2 refs |
