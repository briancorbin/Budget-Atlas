 ...
 * Replaces the binary Raw/Edited toggle. A native range input snapped to
 * five positions, with tick labels above and a one-line description of
 * the current level below. The whole post body re-renders when the slider
 * moves — readers see how the post transforms from raw substrate to
 * published essay.
 *
 * Why a native <input type="range">: keyboard arrow keys work for free,
 * screen readers announce position, and platform UI adapts. The cost is
 * styling — the visible track + thumb get a custom skin via CSS to match
