...
const EditorialLight = () => (
  <>
    <p>
      ...
      don't think I had one. I am comfortable with all of the tools I'm
      using in this project on my own. Stronger with some (the actual
      programming side of things) and weaker in others (like Figma and
      infrastructure stuff like Cloudflare). But I've always been a pretty
      self-driven person when it comes to aggressively learning new tools
    ...
    <p>
      ...
      to 1. find 2. parse 3. document 4. keep up to date 5. verify 6...
      uh.... verify again?
    </p>
    <p>
      It was a bit of both. It was realizing the sad truth of "why doesn't
...
// =============================================================================
//
// All 5 levels render the same 18 AI_LEARNINGS entries from May 7-8.
// What changes is the framing, grouping, and synthesis layered on top.
...
const FieldNotesLight = () => (
  <>
    <p>
      Same 18 entries as Raw, in chronological order, no synthesis. Light
...
const FieldNotesMedium = () => (
  <>
    <p>
      Same 18 entries grouped by primary tag. Still no synthesis.
    </p>
...
// =============================================================================
//
// Each level renders the entire post body — Editorial first, then a
// divider + heading, then Field Notes at the same polish level.
