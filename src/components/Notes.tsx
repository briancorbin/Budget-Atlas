...
export function Notes({ filing }: { filing: FilingStatus }) {
  ...
  const notes = [
    ...
    },
    {
      ...
      body: <>
        ...
        revenue through property tax (Texas effective rates near 1.6%) and sales tax. For a moderate
        income, the savings are real; for renters at low incomes, sales tax is regressive and bites
    ...
    },
    {
      ...
      body: <>
        ...
        (e.g. $200K + $80K), MFJ usually wins — a "marriage bonus." For two near-equal high earners,
        MFJ can produce a small "marriage penalty" above ~$770K combined. FICA is always calculated
        per person, so two earners at $150K each pay more Social Security tax than one earner at $300K.
      </>,
    },
    {
      title: 'Caveats',
      body: <>
        ...
        (rents only), and average local prices. EITC and Child Tax Credit are approximated.
        Real households have wide variance even within the same city and income.
      </>,
    },
  ];
  ...
  return (
    <>
      <div style={{
        marginTop: 60, paddingTop: 24, borderTop: `1px solid ${T.border}`,
        fontSize: 13, color: T.inkSoft, fontFamily: fonts.body, lineHeight: 1.7,
